...
describe BetSerializer do
  ...
  it { expect(subject.as_json).to eq({ id: 628721556, team_home_goals: 1, team_away_goals: 0, team_home: "São Paulo", team_away: "Paraná", round: "1ª", team_home_image_url: "/system/teams/images/136/128/820/original//vagrant/bolao/spec/support/test.png", team_away_image_url: "/system/teams/images/694/025/141/original//vagrant/bolao/spec/support/test.png", weekday: "Qua", time: "15:00", date: "01/01" }) }
end
